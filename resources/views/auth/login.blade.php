            ...
            <div class="splash-container">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <input class="form-control" id="username"s type="text" placeholder="Username" autocomplete="off">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group login-submit"><a class="btn btn-primary btn-xl" href="{{url('/welcome')}}" data-dismiss="modal">Sign me in</a></div>
                    </form>
                </div>
                </div>
